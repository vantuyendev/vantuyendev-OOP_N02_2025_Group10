# 🏪 Hệ Thống Quản Lý Cửa Hàng - Shop Management System
...
Hệ thống quản lý cửa hàng hiện đại được xây dựng bằng Spring Boot với tích hợp cloud database Aiven MySQL, cung cấp giao diện web responsive và hỗ trợ real-time data synchronization.

## 📋 Giới Thiệu Dự Án

Đây là một hệ thống quản lý cửa hàng toàn diện với các tính năng:
